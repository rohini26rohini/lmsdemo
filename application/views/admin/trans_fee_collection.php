            ...
            <div class="row filter">
                ...
                <div class="col-sm-2 col-12">
                    <div class="form-group">
                        ...
                        <a href="<?php echo base_url('/backoffice/transport-fee-collection');?>" class="btn btn-default add_row add_new_btn btn_add_call">
                            Reset
                        </a>
                    </div>
                </div>
            ...
            <div class="table-responsive table_language" style="margin-top:15px;">
                <table id="institute_data" class="table table-striped table-sm dirstudent-list" style="width:100%">
                    ...
                    <tr>
                        ...
                        <td><?php 
                                if ($student['trans_status']== 1) { echo '<span class="admitted">Active</span>';}
                                else if($student['trans_status']==2) { echo '<span class="paymentcompleted">Cancelled</span>';}
                            ?>  
                        </td>
                        <td>
                        <?php if ($student['trans_status']== 1) { ?>
                            <a class="btn btn-primary btn-sm btn_details_view transpay" onclick="loadpayscreen('<?php echo $student['student_id'];?>','<?php echo $student['st_id'];?>')">
                             Pay   
                            </a>
                        <?php } if ($student['trans_status']== 2) { ?>
                            <a class="btn btn-primary btn-sm btn_details_view transpay" onclick="loadpayscreen('<?php echo $student['student_id'];?>','<?php echo $student['st_id'];?>')">
                             View   
                            </a>
                        <?php } ?>
