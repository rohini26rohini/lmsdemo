        ...
        <div>
                ...
                <table style="width:100%;">
                  ...
                  ?>
                    ...
                    <?php } if($paid_payment_mode=='Online'){ ?>
                        <ul style="width:100%;">
                        <li style="float:left;width:33%;font-size:13px;text-align: left;font-family: 'Open Sans', sans-serif;">Transaction Type : <span style="border-bottom: 1px dotted #000;font-weight: 100;margin-left:5px;"><?php if(!empty($feespaid) && $feespaid->card_type != '') { echo $feespaid->card_type; }?></span></li>
                        <li style="float:left;width:33%;font-size:13px;text-align: left;font-family: 'Open Sans', sans-serif;">Transaction Id : <span style="border-bottom: 1px dotted #000;font-weight: 100;margin-left:5px;"><?php if(!empty($feespaid) && $feespaid->transaction_id != '') { echo $feespaid->transaction_id; }?></span></li>
                    ...
                    <?php } ?>
                    <?php /*print_r($feespaid);*///show($feeDet);
                    if(!empty($feespaid) && $feespaid->payment_type=='installment') {
                        ?>
                    <table style="border: 1px solid #989898;width:100%;margin-top:25px;">
                            ...
                            <tbody>
                                <tr style="border: 1px solid #989898;">
                                    ...
                                    <?php if($feeDet['cess']>0) { ?>
                                    <td style="border: 1px solid #989898;font-size:14px;padding:5px;text-align: left;font-family: 'Open Sans', sans-serif;font-weight: 100;">
                                    <?php $cesstval = gstcalculation($inv_amt, $feeDet['cess']);
                                        echo number_format($cesstval, 2); ?>
                                    </td>
                                    <?php } ?>
