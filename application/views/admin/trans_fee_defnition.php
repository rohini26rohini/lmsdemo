        ...
        <div class="table-responsive table_language" style="margin-top:15px;">
            <table id="syllabus_data" class="table table-striped table-sm" style="width:100%">
                ...
                <tr>
                    ...
                    <td>
                        <?php echo $fee->fd_title;?>
                    </td>
                    <td>
                        <?php if($fee->fd_status == 1) {?> 
                            <span class="btn mybutton  mybuttonActive" onclick="statusChange('<?php echo $fee->fd_id;?>','<?php echo $fee->fd_status; ?>')">Active</span>
                        <?php }else if($fee->fd_status == 0){?>
                            <span class="btn mybutton mybuttonInactive" onclick="statusChange('<?php echo $fee->fd_id;?>','<?php echo $fee->fd_status; ?>')">Inactive</span>
                        <?php } ?>
                    </td>
                    <td width="15%">
                        <button  type="button" class="btn btn-default option_btn " onclick="view_feedef('<?php echo $fee->fd_id;?>')" title="Click here to view the details" data-toggle="modal" data-target="#view_fee" style="color:blue;cursor:pointer;">
                            <i class="fa fa-eye "></i>
                        </button>
                        <button class="btn btn-default option_btn " title="Edit" onclick="edit_feedef('<?php echo $fee->fd_id;?>')">
                                ...
                                <table class="table table-bordered table-striped table-sm" id="no-more-tables">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Fee Amount<span class="req redbold">*</span></th>
                                            <th>Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
...
<?php $this->load->view("admin/scripts/trans_fee_definition_script");?>
