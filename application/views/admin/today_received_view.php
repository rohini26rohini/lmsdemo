    ...
    ?>
        <tbody>
            ...
            <tr>
                ...
                <?php if($call->course_id==""){ ?>
                <td><?php echo " ";?></td>
                <?php }else{?>
                    <td><?php echo $this->db->get_where('am_classes' , array('class_id' => $call->course_id))->row()->class_name;?></td>

                <?php }?>                <td><?php echo $call->primary_mobile;?></td>
                <td><?php echo $call->street;?></td>
                <td><?php echo date('d/m/Y h:m:s', strtotime($call->timing));?></td>
<!--
                <td><button type="button" class="btn btn-default option_btn add_new_btn view_btn btn_followup" data-toggle="modal" data-target="#follow_up1" onclick="get_follow_up_data(<?php echo $call->call_id;?>)">
                                Follow Up
                                </button></td>
-->
            </tr>
