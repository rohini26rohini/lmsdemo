    ...
    <div class="white_card">
        ...
        <div class="table-responsive table_language" style="margin-top:15px;">
            <table id="syllabus_data" class="table table-striped table-sm" style="width:100%">
                ...
                <?php 
                $i=1;  
                foreach($approvalArr as $approve){
                     //echo $approve['reporting_head'].'-'.$staff_id['reporting_head'];
                    ...
                    <form id="add_description" type="post">
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="form-group"><label> <?php echo $this->lang->line('reason');?></label>
