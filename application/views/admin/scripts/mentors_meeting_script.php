<script>
    ...
    $("#filter_batch").change(function(){
        ...
        if (batch_id != "" && course_id != "" && center !="") {
            $(".loader").show();
            $.ajax({
                url: '<?php echo base_url();?>backoffice/Students/get_mentors_byBatch',
                type: 'POST',
                data: {
                    batch_id: batch_id,
                    course_id: course_id,
    ...
    $("#filter_batch").change(function(){
        ...
        if (batch_id != "" && course_id != "" && center !="") {
            $(".loader").show();
            $.ajax({
                url: '<?php echo base_url();?>backoffice/Students/get_rooms_byBatch',
                type: 'POST',
                data: {
                    batch_id: batch_id,
                    course_id: course_id,
    ...
    function search(){
        ...
        $.ajax({
            url: '<?php echo base_url();?>backoffice/Students/get_student_list_byMentor',
            type: "post",
...
function get_meetingdata(id){
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            get_rooms(obj.meetings.room_id);
            $(".loader").hide();
        }
    });
}
