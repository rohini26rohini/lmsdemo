<div class="content_wrapper relative col-lg-10 col-md-8 col-sm-8 col-xs-12 ">
    <div class="white_card ">
        <h6><?php echo $this->lang->line('exam_schedule_report'); ?></h6>
        <hr>
         <form id="search_form">
        <div class="row filter">
            ...
            <div class="col-sm-2 col-12">
                ...
                <?php $batches = $this->common->get_alldata('am_batch_center_mapping',array("batch_status"=>1));?>
                    <select class="form-control" id="filter_batch1" name="batch_id">
            ...
            <div class="col-sm-2 col-12">
                ...
                <label><?php echo $this->lang->line('status');?></label>
                    <select class="form-control" id="filter_status" name="status">
                        ...
                        <option value="4">RESULT PUBLISHED</option>
          ...
          <div class="col-sm-2 col-12">
            ...
            <div class="col-sm-12 col-12 filerPad text-right">
                ...
                <a class="btn btn-default add_row add_new_btn btn_add_call" href="<?php echo base_url('backoffice/exam-schedule-report');?>">
                              Reset</a>
            </div>
        </div>
        </form>
    ...
    <form id="filter_form" method="post" action="<?php echo base_url('backoffice/Report/export_exam_report');?>">
    <input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>" />
...
<?php $this->load->view("admin/scripts/exam_schedule_report_script");?>
