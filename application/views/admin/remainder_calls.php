            ...
            <div class="white_card">
                ...
                <div class="row filter" id="example">
                    <div class="col-sm-2 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="filter_date" id="filter_date" class="form-control dates" placeholder="<?php echo date('d-m-Y');?>" autocomplete="off"/>
                        </div>
                    </div>
                    <div class="col-sm-2 col-12">
                        <!-- <div class="form-group">
                ...
                <div id="result">
                    <div class="table-responsive table_language" style="margin-top:15px;">
                        <table id="remaindercallcenter_table" class="table table-striped table-sm" style="width:100%">
                            <thead>
                                <tr>
                                    <th>Sl. No.</th>
                                    <th>Reference Key</th>
                            ...
                            <tr id="row_<?php echo $calls['call_id'];?>">
                                ...
                                <td class="remainderfollow">
                                    ...
                                    <button type="button" class="btn btn-default option_btn add_new_btn " title="Edit" onclick="get_editdata(<?php echo $calls['call_id'];?>)">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-12">
                                ...
                                <!-- </div> -->
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div class="form-group" ><label>Next Reminder Date</label>
                                            <input class="form-control datetimenext " type="text" name="nextremainder" placeholder="Next Reminder Date" autocomplete="off">
                                        </div>
                                    </div>
                    ...
                    <div id="head2" class="tab-pane">
                        ...
                        <form id="add_followup" type="post">
                            <div class="row">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="form-group"><label> Next Reminder Date</label>
                                    <input class="form-control datetimenext" type="text" id="followup_next_remainder" name="followup_next_remainder" placeholder="Next Reminder Date" autocomplete="off">
                                    </div>
                                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="form-group" ><label>Next Reminder Date</label>
                            <input class="form-control datetimenext" type="text" id="nextremainder" name="nextremainder" placeholder="Next Reminder Date" autocomplete="off" readonly="readonly">
                        </div>
                    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <th width="50%">
                                    ...
                                    Progress status :
                                        <div class="media-body">
                                            <label class="mt-0 ml-2 mb-0"><span id="progress_status"></span></label>
                                        </div>
                                    </div>
                                </th>
                            </tr>
                    ...
                    <div id="head2" class="tab-pane">
                        ...
                        <form id="add_followup" type="post">
                            <div class="row">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="form-group"><label> Next Reminder Date</label>
                                    <input class="form-control datetimenext" type="text" id="followup_editnext_remainder" name="followup_next_remainder" placeholder="Next Reminder Date" autocomplete="off">
                                    </div>
                                </div>
