...
<div class="content_wrapper relative col-lg-10 col-md-9 col-sm-9 col-xs-12 ">
    <?php if(isset($cce)){ //print_r($total);//print_r($staff);?>
     <div class="header_card">
                        <h4>Header</h4>
<!--                        <input class="form-control dateOnly filter_class batch_drop" type="text" id="created_on" name="created_on" placeholder="Pick a Date">-->
                    </div>            
        ...
        <div class="row">
            ...
            <!-- <div id="result"> -->
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12" id="result1">
                    <a href="<?php echo base_url('backoffice/call-received-today');?>"><div class="dash_box dash_box_in">
                ...
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12" id="result2">
                    <a href="<?php echo base_url('backoffice/call-admitted-today');?>"><div class="dash_box dash_box_in">
            ...
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                <a href="<?php echo base_url('backoffice/manage-calls');?>"><div class="dash_box dash_box_in">
                    <p>Total Call Received</p>
                    <h4><?php echo (isset($total))?$total['totalcall_received']:'';?></h4>
                </div></a>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                <a href="<?php echo base_url('backoffice/admitted-call-list');?>"><div class="dash_box dash_box_in">
                    <p>Total Admitted</p>
                    <h4><?php echo (isset($total))?$total['totalcall_converted']:'';?></h4>
                </div></a>
            </div>
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12" >
                    <a href="<?php echo base_url('backoffice/in-progress-call-list');?>"><div class="dash_box dash_box_in">
                        <p>Calls In Progress</p>
                        <h4><?php echo $inprogress;?></h4>
                    </div></a>
                </div>
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12" >
                    <a href="<?php echo base_url('backoffice/closed-call-list');?>"><div class="dash_box dash_box_in">
                        <p>Calls Closed</p>
...
<h6>Conversion Ratio</h6>
    ...
    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12" >
        <a href="<?php echo base_url('backoffice/registered-call-list');?>"><div class="dash_box dash_box_in">
            ...
            <?php 
            foreach($cce as $staff) {
            $conversion = $this->common->get_conversionrate($staff['personal_id'], date('Y-m-d')); 
            ...
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                        ...
                        <div class="time_table">
                            ...
                            <ul>
                                <li><strong><?php echo $staff['name'];?></strong></li>
                                <li><span>Total <?php echo (isset($conversion))?$conversion['totalcall_converted']:'';?>/<?php echo (isset($conversion))?$conversion['totalcall_received']:'';?> - </span>Rate : <?php 
                                $percentage = 0;
                                if(isset($conversion) && $conversion['totalcall_received']>0) {
                                    $rate = $conversion['totalcall_converted']/$conversion['totalcall_received'];
                                    $percentage = $rate*100;
                                }
                                echo $percentage.'%';
                                ?></li>
