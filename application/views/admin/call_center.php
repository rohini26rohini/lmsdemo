<div class="content_wrapper relative col-lg-10 col-md-8 col-sm-8 col-xs-12 ">
    <?php if(!isset($callEdit)){?>
        <?php if($this->session->userdata('role')=='cce') { ?>
            <div class="white_card">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                    <h6>Call Summary</h6><hr/>
                        <div class="row">
            ...
            <div class="white_card">
                ...
                <div class="row filter" id="example">
                    ...
                    <div class="col-sm-2 col-12">
                        <div class="form-group">
                            <label>Status</label>
                            <select class="form-control filter_change" name="filter_status" id="filter_status">
                    ...
                    <div class="col-sm-2 col-12">
                        ...
                        <label>Enquiry Type</label>
                            <select name="filter_enquiry" id="filter_enquiry"  class="form-control filter_change"/>
                                ...
                                <option value="Mission Batch">Mission Batch</option>
                                ...
                                <option value="Personal Reasons(Like Financial issue, Accident etc)">Personal Reasons(Like Financial issue, Accident etc)</option>
                                <option value="Others">Others</option>
                            </select>
                        </div>
                    </div>
            ...
            <div class="white_card"> 
                <div class="row ">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right flex-row-reverse ">
                        <!-- <button type="button" class="btn btn-default add_row add_new_btn btn_add_call" onClick="redirect('backoffice/reference-list');">
                            My References
                        </button> -->
                        <button type="button" class="btn btn-default add_row add_new_btn btn_add_call" onclick="clear_form()" data-toggle="modal" data-target="#add_call_center">
                            Add New Call
                        </button>
                    </div>
                </div>
                    <div class="table-responsive table_language" style="margin-top:15px;" id="result">
                        <table id="callcenter_table1" class="table table-striped table-sm" style="width:100%">
                            <thead>
                                <tr>
                                    <th>Sl. No.</th>
                                    <th>Reference Key</th>
                            ...
                            // foreach($call_centerArr as $calls){?>
                             <!-- <tr id="row_<?php echo $calls['call_id'];?>">
                                 ...
                                 <td width="20%">
                                     ...
                                     <button type="button" title="Edit" class="btn btn-default option_btn add_new_btn " onclick="get_editdata(<?php echo $calls['call_id'];?>)">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div class="form-group"><label>Caller Details</label><span class="req redbold">*</span>
                                            <select class="form-control" name="caller_details" id="caller_details" data-validate="required">
                                                <option value="">Select</option>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12" >
                                        <div class="form-group"><label>Main Course<span id="course_label" class="req redbold mandatoryhidden">*</span></label>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12" >
                                        <div class="form-group"><label>Secondary Courses<span id="course_label" class="req redbold mandatoryhidden">*</span></label>
                                            <select class="form-control" name="seccourse_id[]" id="seccourse" multiple="multiple" style="height:100px;">
                                                <option value="">Select Course</option>
                                                    <?php foreach($courseArr as $course) {
                                                    if($course['status']==1) {
                                                    ?>
                                ...
                                <!-- </div> -->
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div class="form-group" ><label>Next Remainder Date</label>
                                            <input class="form-control datetimenext " type="text" name="nextremainder" placeholder="Next Remainder Date" autocomplete="off">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div class="form-group"><label> Qualification</label>
                                            <select class="form-control" name="qualification">
                                                <option value="">Select</option>
                                                <?php
                                                $qualifications = $this->common->get_qualifications();
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div class="form-group"><label>How did you know about the course?</label>
                                            <!-- <input class="form-control" type="text" name="source" placeholder="How did you know about the course?" autocomplete="off"> -->
                                            <select class="form-control" name="source">
                                                <option value="">Select Source</option>
                                                <option value="Social media">Social media</option>
                                                <option value="Direction website">Direction website</option>
                                                ...
                                                <option value="Newspaper Advertising">Newspaper Advertising</option>
                                    ...
                                    <!-- <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div class="form-group"><label>Referenced By</label>
                                            <input class="form-control" type="text" name="referred_by"  placeholder="Referenced By" autocomplete="off">
                                        </div>
                                    </div> -->
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div class="form-group">
                                    ...
                                    <input list="reference" name="referred_by" class="form-control" autocomplete="off" placeholder="Referenced By">
                                    <datalist id="reference">
                                    <?php
                                    foreach($referenceArr as $data){ ?>
                                        <option value="<?php echo $data->rand_num;?>"><?php echo $data->rand_num;?></option>
                                        <?php }?>
                                    </datalist>
                                </div>
                                    </div>
                    ...
                    <div id="head2" class="tab-pane">
                        ...
                        <form id="add_followup" type="post">
                            <div class="row">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="form-group"><label> Next Remainder Date</label>
                                    <input class="form-control datetimenext" type="text" id="followup_next_remainder" name="followup_next_remainder" placeholder="Next Remainder Date" autocomplete="off">
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="assigned_to" id="assigned_to">
                                            <option value="">Select</option>
                                            <?php foreach($usersArr as $users){?>
                                                <?php  if($users['role']=='centerhead' || $users['role']=='cch'|| $users['role']=='cce'|| $users['role']=='management'){ ?>
                                            <option value="<?php  echo $users['personal_id'] ?>"><?php  echo $users['name'] ?></option>
                                            <?php } }?>
                                        </select>
                                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="form-group">
                            <label>Enquiry Type<span class="req redbold">*</span></label>
                            <select disabled class="form-control" name="enquiry_type" id="edit_enquiry_type" autocomplete="off" data-validate="required" onchange="edit_get_type(); edit_enquiry_type();" readonly="readonly">
                                <!-- <option value="">Select Enquiry Type</option> -->
                                <option value="Course related">Course related</option>
                                <option value="Fee related">Fee related</option>
                                <option value="Parent call">Parent call</option>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="form-group"><label>Caller Details</label><span class="req redbold">*</span>
                            <select class="form-control" name="caller_details" id="edit_caller_details" data-validate="required" readonly="readonly">
                                <option value="">Select</option>
                                <option value="Candidate">Candidate</option>
                                <option value="Parent">Parent</option>
                                <option value="Spouse">Spouse</option>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12" >
                                        <div class="form-group"><label>Secondary Courses<span id="course_label" class="req redbold mandatoryhidden">*</span></label>
                                            <select class="form-control" name="seccourse_id[]" id="seccourse_edit" multiple="multiple" style="height:100px;" readonly="readonly">
                                                <option value="">Select Course</option>
                                                    <?php foreach($courseArr as $course) {
                                                    if($course['status']==1) {
                                                    ?>
                    ...
                    <!-- </div> -->
                    <div class="col-6" id="edit_others" style="display:none;">
                                        <!-- <div class="row">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" >
                                                <div class="form-group">
                                                    <label>Other Type<span class="req redbold">*</span></label>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="form-group" ><label>Next Remainder Date</label>
                            <input class="form-control datetimenext" type="text" id="nextremainder" name="nextremainder" placeholder="Next Remainder Date" autocomplete="off" readonly="readonly">
                        </div>
                    </div>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" id="edit_course_related" >
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="form-group"><label> How did you know about the course?</label>
                            <!-- <input class="form-control" type="text" name="source" placeholder="How did you know about the course?" id="edit_source" autocomplete="off"> -->
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <!-- <div class="form-group"><label>Referenced By</label>
                            <input class="form-control" type="text" name="referred_by" id="edit_referred_by" placeholder="Referenced By" autocomplete="off">
                        </div> -->
                        <div class="form-group">
                        <label>Referenced By</label>
                                <!-- <input type="hidden" id="id" name="call_id" class="form-control" /> -->
                                <input list="edit_reference" name="referred_by" id="edit_referred_by" class="form-control" autocomplete="off" placeholder="Referenced By">
                                <datalist id="edit_reference">
                                <?php
                                   foreach($referenceArr as $data){ ?>
                                    <option value="<?php echo $data->rand_num;?>"><?php echo $data->rand_num;?></option>
                                    <?php }?>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th width="50%">
                                    ...
                                    Caller Details :
                                        <div class="media-body">
                                            <label class="mt-0 ml-2 mb-0"><span id="show_caller_details"></span></label>
                                        </div>
                                    </div>   
                                </th>
                                <th width="50%">
                            ...
                            <tr>
                                ...
                                <th width="50%">
                                    ...
                                    Progress :
                                        <div class="media-body">
                                            <label class="mt-0 ml-2 mb-0"><span id="show_hotcold" style="color:red;"></span></label>
                                        </div>
                                    </div>
                                </th>
                            </tr>
                            <tr>
                                ...
                                <div class="media">
                                    Next Remainder Date :
                                        <div class="media-body">
                                            <label class="mt-0 ml-2 mb-0"><span id="show_nextremainder"></span></label>
                                        </div>
                                    </div>   
                                </th>
                                <th width="50%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th width="50%">
                                 ...
                                 <th width="50%">
                                    ...
                                    Secondary Courses :
                                        <div class="media-body">
                                            <label class="mt-0 ml-2 mb-0"><span id="secondarycourse"></span></label>
                                        </div>
                                    </div>          
                                </th>
                            </tr> 
                            ...
                            <th width="50%">
                                ...
                                <th width="50%">
                                    ...
                                    Referenced by :
                                        <div class="media-body">
                                            <label class="mt-0 ml-2 mb-0"><span id="rferenced_by"></span></label>
                                        </div>
                                    </div>       
                                </th>
                    ...
                    <div id="head2" class="tab-pane">
                        ...
                        <form id="add_followup" type="post">
                            <div class="row">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="form-group"><label> Next Remainder Date</label>
                                    <input class="form-control datetimenext" type="text" id="followup_editnext_remainder" name="followup_next_remainder" placeholder="Next Remainder Date" autocomplete="off">
                                    </div>
                                </div>
