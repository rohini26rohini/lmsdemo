<div class="content_wrapper relative col-lg-10 col-md-9 col-sm-9 col-xs-12 ">
    ...
    <div class="white_card ">
        ...
        <ul class="nav nav-pills">
            ...
            <li class="nav-item">
                <a class="nav-link educational_qualification" data-toggle="pill" href="#educational_qualification" disabled>Educational Qualifications</a>
            </li>
            <li class="nav-item">
        ...
        <div class="tab-content">
            <div id="personal_details" class=" tab-pane active">
                <form id="add_personal_details_form" method="post" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="name" id="name" placeholder="Name" aria-label="Text input with dropdown button" data-validate="required">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <?php foreach($roleArr as $role){
                                         $selected = '';
                                         if($staffArr['role'] == $role['roles_id']){
                                            $selected = 'selected="selected"';
                                          }
                                          echo '<option value="'.$role['role'].'" '.$selected.'>'.$role['role_name'].'</option>'; 
                                        }
                                    ?>
                                     <!-- <option  value="<?php// echo $role['roles_id']'.$selected.';?>"><?php //echo $role['role_name'];?></option> -->
                                     <?php //} ?>
                                </select>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control calendarclass" name="dob" id="dob" placeholder="Date Of Birth" data-validate="required">
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                ...
                                <input class="form-control" name="spouse_name" id="spouse_name" placeholder="Spouse Name" />
                            </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="mobile" id="mobile" placeholder="Primary Contact No/Mobile No." />
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                            <div class="form-group">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="permanent_address" id="permanent_address" placeholder="Permenent Address" data-validate="required"></textarea>
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
...
-->
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="body_reg" id="body_reg" data-validate="required"></textarea>
                            </div>
                        </div>
<!--
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
...
-->
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="aadhar_no" id="aadhar_no" placeholder="Aadhar Card No." data-validate="required"/>
                            </div>
                        </div>
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
                            <div class="form-group">
                                <label>PAN Card No.<span class="req redbold">*</span></label>
                                <input class="form-control" name="pan_no" id="pan_no" placeholder="PAN Card No." data-validate="required"/>
                            </div>
                        </div>
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
                            <div class="form-group">
                                <label>SBT Account No.<span class="req redbold">*</span></label>
                                <input class="form-control" name="ac_no" id="ac_no" placeholder="SBT Account No." data-validate="required"/>
                            </div>
                        </div>
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
                            <div class="form-group">
                                <label> IFSC code<span class="req redbold">*</span></label>
                                <input class="form-control" name="ifsc_code" id="ifsc_code" placeholder="IFSC code" data-validate="required"/>
                            </div>
                        </div>
            ...
            <div id="educational_qualification" class=" tab-pane fade">
                <form id="add_educational_qualification_form" method="post">
                        ...
                        <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-md-6 col-lg-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="school[]" id="school" placeholder="School/College" />
                                        </div>
                                    </div>
                                    <div class="col-xl-6 col-md-6 col-lg-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            <label>Year of Passing</label>
                                            <input class="form-control year" name="passing_year[]" id="passing_year" placeholder="Year of Passing" />
                                        </div>
                                    </div>
                                    <div class="col-xl-6 col-md-6 col-lg-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            <label>Marks in Percentage</label>
                                            <input class="form-control" name="marks[]" id="marks" placeholder="Marks in Percentage" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-md-4 col-lg-4 col-sm-4 col-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="university[]" id="university" rows="5" placeholder="University/Institute with City &amp; State"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                <label class="legendlabel">Class X II or Equivalent</label>
                            </div>
                        </div>
                    </div>
                    <div class="outline">
                                ...
                                <div class="row">
                                    <div class="col-xl-6 col-md-6 col-lg-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <select type="text" class="form-control subject_select" placeholder="Email" name="specification[]">
                        <option value="">Select</option>
                                        <option  >AHSS</option>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                <label class="legendlabel">PG & Above</label>
                            </div>
                        </div>
                    </div>
                    <div class="outline">
            ...
            <div id="approval" class=" tab-pane fade">
                <form id="add_approval_form" method="post">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-md-6 col-lg-6 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" data-validate="required"/>
                                </div>
                            </div>
                            <div class="col-xl-6 col-md-6 col-lg-6 col-sm-6 col-12">
                                <div class="form-group">
                                    <label>Documents<span class="req redbold">*</span></label>
                                    <input class="form-control" type="file" name="documents" data-validate="required"/>
                                </div>
                            </div>
                        </div>
                        <button class="btn btn-default add_wrap_pos">
...
<div class="white_card ">
    ...
    <ul class="nav nav-pills">
        ...
        <?php if(!empty($staffEdit)&& $staffEdit['role']==2) { ?>
        <li class="nav-item">
            <a class="nav-link subject" data-toggle="pill" href="#subject">Subject</a>
        </li>
        <?php } ?>
    ...
    <div class="tab-content">
        <div id="personal_details" class=" tab-pane active">
            <form id="edit_personal_details_form" method="post">
                <div class="avathar_wrap">
                    <div class="avathar_img">
                        <input type="file" />
                    </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="name" id="name" placeholder="Name" aria-label="Text input with dropdown button" data-validate="required" value="<?php echo !empty($staffEdit)?$staffEdit['name']:''; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="role" id="role">
                                    ...
                                    ?>
                                    <option value="<?php echo $row2['roles_id'];?>" 
                                        <?php if($staffEdit['role'] == $row2['roles_id'])echo 'selected';?>>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="mobile" id="mobile" placeholder="Mobile No." value="<?php echo !empty($staffEdit)?$staffEdit['mobile']:''; ?>" />
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                        <div class="form-group">
                            <label>LandLine No.</label>
                            <input class="form-control" name="landline" id="landline" placeholder="LandLine No." value="<?php echo !empty($staffEdit)?$staffEdit['landline']:''; ?>" />
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                        <div class="form-group">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                        <div class="form-group">
                            <label>Spouse Name</label>
                            <input class="form-control" name="spouse_name" id="spouse_name" placeholder="Spouse Name" value="<?php echo !empty($staffEdit)?$staffEdit['spouse_name']:''; ?>" />
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                        <div class="form-group">
                            <label>Occupation</label>
                            <input class="form-control" name="spouse_job" id="spouse_job" placeholder="Occupation" value="<?php echo !empty($staffEdit)?$staffEdit['spouse_job']:''; ?>" />
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="spouse_country" id="spouse_country">
                                ...
                                <?php 
                                    ...
                                    <option value="<?php echo $row2['id'];?>" 
                                        <?php if($staffEdit['spouse_country'] == $row2['id'])echo 'selected';?>>
                                        <?php echo $row2['name'];?>
                                    </option>
                                <?php endforeach;  ?>
                            </select>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
                        <div class="form-group">
                            <label>Father's Name</label>
                            <input class="form-control" name="father_name" id="father_name" placeholder="Father's Name" value="<?php echo !empty($staffEdit)?$staffEdit['father_name']:''; ?>" />
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
                        <div class="form-group">
                            <label>Occupation</label>
                            <input class="form-control" name="father_job" id="father_job" placeholder="Occupation" value="<?php echo !empty($staffEdit)?$staffEdit['father_job']:''; ?>" />
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
                        <div class="form-group">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" data-validate="required" name="body_reg" id="body_reg"><?php echo !empty($staffEdit)?$staffEdit['body_reg']:''; ?></textarea>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                        <div class="form-group">
                            <label>Regn. No</label>
                            <input class="form-control" name="reg_no" id="reg_no" placeholder="Regn. No" value="<?php echo !empty($staffEdit)?$staffEdit['reg_no']:''; ?>" />
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                        <div class="form-group">
                            <label>Issue Date</label>
                            <input class="form-control calendarclass" name="issue_date" id="issue_date" placeholder="Issue Date" value="<?php echo !empty($staffEdit)?$staffEdit['issue_date']:''; ?>" />
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                        <div class="form-group">
                            <label>Expiry Date</label>
                            <input class="form-control calendarclass" name="exp_date" id="exp_date" placeholder="Expiry Date" value="<?php echo !empty($staffEdit)?$staffEdit['exp_date']:''; ?>" />
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
                        <div class="form-group">
                            <label>PAN Card No.<span class="req redbold">*</span></label>
                            <input class="form-control" data-validate="required" name="pan_no" id="pan_no" placeholder="PAN Card No." value="<?php echo !empty($staffEdit)?$staffEdit['pan_no']:''; ?>" />
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
                        <div class="form-group">
                            <label>SBT Account No.<span class="req redbold">*</span></label>
                            <input class="form-control" data-validate="required" name="ac_no" id="ac_no" placeholder="SBT Account No." value="<?php echo !empty($staffEdit)?$staffEdit['ac_no']:''; ?>" />
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
                        <div class="form-group">
                            <label> IFSC code<span class="req redbold">*</span></label>
                            <input class="form-control" data-validate="required" name="ifsc_code" id="ifsc_code" placeholder="IFSC code" value="<?php echo !empty($staffEdit)?$staffEdit['ifsc_code']:''; ?>" />
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
                        <div class="form-group">
                            <label>Aadhar Card No.<span class="req redbold">*</span></label>
                            <input class="form-control" data-validate="required" name="aadhar_no" id="aadhar_no" placeholder="Aadhar Card No." value="<?php echo !empty($staffEdit)?$staffEdit['aadhar_no']:''; ?>" />
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="form-group">
                            <label>Permenent Address<span class="req redbold">*</span></label>
                            <textarea class="form-control" data-validate="required" name="permanent_address" id="permanent_address" placeholder="Permenent Address" value=""><?php echo !empty($staffEdit)?$staffEdit['permanent_address']:''; ?></textarea>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="form-group">
                ...
                <div class="outline">
                    <div class="row">
                            ...
                            ?>
                                    <div class="col-xl-6 col-md-6 col-lg-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            <label>Specification</label>
                                            <select type="text" class="form-control subject_select" name="specification[]">
                                            <?php echo (isset($Classx) && $Classx['specification']!='')?'<option selected="selected">'.$Classx['specification'].'</option>':'';
                                            ?>
                                            <option value="">Select</option>
                                            <option  >AHSLC</option>
                                            <option  >Anglo Indian School Leaving Certificate</option>
                                    ...
                                    <div class="col-xl-6 col-md-6 col-lg-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            <label>School/College</label>
                                            <input class="form-control" name="school[]" id="school" placeholder="School/College" value="<?php echo (isset($Classx) && $Classx['school']!='')?$Classx['school']:'';
                                            ?>" />
                                        </div>
                                    </div>
                                    <div class="col-xl-6 col-md-6 col-lg-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            <label>Year of Passing</label>
                                            <input class="form-control year" name="passing_year[]" id="passing_year" placeholder="Year of Passing" value="<?php echo (isset($Classx) && $Classx['passing_year']!='')?$Classx['passing_year']:'';
                                            ?>" />
                                        </div>
                                    </div>
                                    <div class="col-xl-6 col-md-6 col-lg-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            <label>Marks in Percentage</label>
                                            <input class="form-control" name="marks[]" id="marks" placeholder="Marks in Percentage" value="<?php echo (isset($Classx) && $Classx['marks']!='')?$Classx['marks']:'';
                                            ?>" />
                                        </div>
                                    </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-md-4 col-lg-4 col-sm-4 col-12">
                            <div class="form-group">
                                <label>University/Institute with City &amp; State</label>
                                <textarea class="form-control" rows="5" name="university[]" id="university" placeholder="University/Institute with City &amp; State"><?php echo (isset($Classx) && $Classx['university']!='')?$Classx['university']:'';
                                            ?></textarea>
                            </div>
                        </div>
                    </div>
                ...
                <div class="outline">
                    <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-md-6 col-lg-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label>Specification</label>
                                        <select type="text" class="form-control subject_select" name="specification[]">
                                        <?php echo (isset($Classxii) && $Classxii['specification']!='')?'<option selected="selected">'.$Classxii['specification'].'</option>':'';
                                            ?>
                                        <option value="">Select</option>
                                        <option  >AHSS</option>
                                        <option  >CBSE XIIth</option>
                                ...
                                <div class="col-xl-6 col-md-6 col-lg-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label>School/College</label>
                                        <input class="form-control" name="school[]" id="school" placeholder="School/College" value="<?php echo (isset($Classxii) && $Classxii['school']!='')?$Classxii['school']:'';
                                            ?>" />
                                    </div>
                                </div>
                                <div class="col-xl-6 col-md-6 col-lg-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label>Year of Passing</label>
                                        <input class="form-control year" name="passing_year[]" id="passing_year" placeholder="Year of Passing" value="<?php echo (isset($Classxii) && $Classxii['passing_year']!='')?$Classxii['passing_year']:'';
                                            ?>" />
                                    </div>
                                </div>
                                <div class="col-xl-6 col-md-6 col-lg-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label>Marks in Percentage</label>
                                        <input class="form-control" name="marks[]" id="marks" placeholder="Marks in Percentage" value="<?php echo (isset($Classxii) && $Classxii['marks']!='')?$Classxii['marks']:'';
                                            ?>" />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-md-4 col-lg-4 col-sm-4 col-12">
                            <div class="form-group">
                                <label>University/Institute with City &amp; State</label>
                                <textarea class="form-control" rows="5" name="university[]" id="university" placeholder="University/Institute with City &amp; State"><?php echo (isset($Classxii) && $Classxii['university']!='')?$Classxii['university']:'';
                                            ?></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="outline">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-md-6 col-lg-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            <label>Specification</label>
                                            <select type="text" class="form-control subject_select" name="specification[]">
                                            <?php echo (isset($Degree) && $Degree['specification']!='')?'<option selected="selected">'.$Degree['specification'].'</option>':'';
                                            ?>
                                        <option value="">Select</option>
                        <option >B Voc</option>
                        <option  >BA</option>
                        ...
                        <option  >Post Basic B.Sc</option>
                                    ...
                                    <div class="col-xl-6 col-md-6 col-lg-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            <label>School/College</label>
                                            <input class="form-control" name="school[]" id="school" placeholder="School/College" value="<?php echo (isset($Degree) && $Degree['school']!='')?$Degree['school']:'';
                                            ?>" />
                                        </div>
                                    </div>
                                    <div class="col-xl-6 col-md-6 col-lg-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            <label>Year of Passing</label>
                                            <input class="form-control year" name="passing_year[]" id="passing_year" placeholder="Year of Passing" value="<?php echo (isset($Degree) && $Degree['passing_year']!='')?$Degree['passing_year']:'';
                                            ?>" />
                                        </div>
                                    </div>
                                    <div class="col-xl-6 col-md-6 col-lg-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            <label>Marks in Percentage</label>
                                            <input class="form-control" name="marks[]" id="marks" placeholder="Marks in Percentage" value="<?php echo (isset($Degree) && $Degree['marks']!='')?$Degree['marks']:'';
                                            ?>" />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-4 col-md-4 col-lg-4 col-sm-4 col-12">
                                <div class="form-group">
                                    <label>University/Institute with City &amp; State</label>
                                    <textarea class="form-control" rows="5" name="university[]" id="university" placeholder="University/Institute with City &amp; State"><?php echo (isset($Degree) && $Degree['university']!='')?$Degree['university']:'';
                                            ?></textarea>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="outline">
                        <div class="row">
                            <div class="col-xl-8 col-md-8 col-lg-8 col-sm-8 col-12">
                                <div class="row">
                                    ...
                                    <input name="category[]" value="PG" type="hidden" />
                                    <?php
                                        $pg = $this->common->get_classx_qualify($personal_id, 'Degree');
                                        if(!empty($pg)){
                                    ...
                                    <div class="col-xl-6 col-md-6 col-lg-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            <label>Specification</label>
                                            <select type="text" class="form-control subject_select" name="specification[]">
                                                <?php echo (isset($pg) && $pg['specification']!='')?'<option selected="selected">'.$pg['specification'].'</option>':'';
                                                ?>
                                        <option  value="" >Select</option>
                        <option value="Bsc. - Msc. Integrated"> Bsc. - Msc. Integrated</option>
                        <option value="BA - MA Integrated">BA - MA Integrated</option>
                        ...
                        <option value="Professional Diploma in Clinical Psychology">Professional Diploma in Clinical Psychology</option>
                                    ...
                                    <div class="col-xl-6 col-md-6 col-lg-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            <label>School/College</label>
                                            <input class="form-control" name="school[]" id="school" placeholder="School/College" value="<?php echo (isset($pg) && $pg['school']!='')?$pg['school']:'';
                                            ?>" />
                                        </div>
                                    </div>
                                    <div class="col-xl-6 col-md-6 col-lg-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            <label>Year of Passing</label>
                                            <input class="form-control year" name="passing_year[]" id="passing_year" placeholder="Year of Passing" value="<?php echo (isset($pg) && $pg['passing_year']!='')?$pg['passing_year']:'';
                                            ?>" />
                                        </div>
                                    </div>
                                    <div class="col-xl-6 col-md-6 col-lg-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            <label>Marks in Percentage</label>
                                            <input class="form-control" name="marks[]" id="marks" placeholder="Marks in Percentage" value="<?php echo (isset($pg) && $pg['marks']!='')?$pg['marks']:'';
                                            ?>" />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-4 col-md-4 col-lg-4 col-sm-4 col-12">
                                <div class="form-group">
                                    <label>University/Institute with City &amp; State</label>
                                    <textarea class="form-control" rows="5" name="university[]" id="university" placeholder="University/Institute with City &amp; State"><?php echo (isset($pg) && $pg['university']!='')?$pg['university']:'';
                                            ?></textarea>
                                </div>
                            </div>
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="add_wrap">
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-md-3 col-lg-3 col-sm-3 col-12">
                                    <div class="form-group">
                                        <label>Designation</label>
                                        <input class="form-control" name="designationedit[]" id="designation" placeholder="Designation" value="<?php echo $ex['designation'];?>" />
                                    </div>
                                </div>
                                <div class="col-xl-3 col-md-3 col-lg-3 col-sm-3 col-12">
                                    <div class="form-group">
                                        <label>Department</label>
                                        <input class="form-control" name="departmentedit[]" id="department" placeholder="Department" value="<?php echo $ex['department'];?>" />
                                    </div>
                                </div>
                                <div class="col-xl-2 col-md-2 col-lg-2 col-sm-2 col-12">
                                    <div class="form-group">
                                ...
                                <div class="col-xl-2 col-md-2 col-lg-2 col-sm-2 col-12">
                                    <div class="form-group">
                                        <label>Total Service</label>
                                        <input class="form-control" name="total_serviceedit[]" id="total_service" placeholder="Total Service" value="<?php echo $ex['total_service'];?>" />
                                    </div>
                                </div>
                                <div class="col-xl-3 col-md-3 col-lg-3 col-sm-3 col-12">
                                    <div class="form-group">
                                        <label>Institution</label>
                                        <input class="form-control" name="institutionedit[]" id="institution" placeholder="Institution" value="<?php echo $ex['institution'];?>" />
                                    </div>
                                </div>
                                <div class="col-xl-3 col-md-3 col-lg-3 col-sm-3 col-12">
                                    <div class="form-group">
                                ...
                                <div class="col-xl-2 col-md-2 col-lg-2 col-sm-2 col-12">
                                    <div class="form-group">
                                        <label>PF Account No.</label>
                                        <input class="form-control" name="pf_ac_noedit[]" id="pf_ac_no" placeholder="PF Account No." value="<?php echo $ex['pf_ac_no'];?>" />
                                    </div>
                                </div>
                            </div>
                            <?php
                    ...
                    <?php
                        ...
                        <div class="add_wrap">
                            ...
                            <div class="col-xl-2 col-md-2 col-lg-2 col-sm-2 col-12">
                                <div class="form-group">
                                    <label>Total Service</label>
                                    <input class="form-control" name="total_service[]" id="total_service" placeholder="Total Service" />
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-3 col-lg-3 col-sm-3 col-12">
                                <div class="form-group">
                            ...
                            <div class="col-xl-2 col-md-2 col-lg-2 col-sm-2 col-12">
                                <div class="form-group">
                                    <label>PF Account No.</label>
                                    <input class="form-control" name="pf_ac_no[]" id="pf_ac_no" placeholder="PF Account No." />
                                </div>
                            </div>
                            <button type="button" id="add_block" class="btn btn-default add_wrap_pos">
                        <i class="fa fa-plus"></i>
            ...
            <form id="edit_approval_form" method="post">
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                        <div class="form-group">
                            <label>   Reporting Officer/Line Manager </label>
                            <input class="form-control" name="reporting_head" value="<?php echo !empty($staffEdit)?$staffEdit['reporting_head']:''; ?>" />
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                        <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="area_outline">
                        <div class="row">
                            ...
                            <span id="strong_modules" style="width:100%;">
                            </span>
                        </div>
                    </div>
                    <div class="area_outline">
                        ...
                        <span  style="width:100%;" id="othersubjects">
                        </span>
                    </div>
                        </div>
                    </div>
