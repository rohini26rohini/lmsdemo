            ...
            <div class="white_card">
                ...
                <div class="row filter" id="example">
                    ...
                    <div class="col-sm-2 col-12">
                        <div class="form-group">
                            <label>Course</label>
                            <input type="text" name="filter_course" id="filter_course" class="form-control filter_class" placeholder="Search..." autocomplete="off"/>
                        </div>
                    </div>
                    <div class="col-sm-2 col-12">
                        <div class="form-group">
                    ...
                    <div class="col-sm-2 col-12">
                        ...
                        <label>Enquiry Type</label>
                            <select name="filter_enquiry" id="filter_enquiry"  class="form-control filter_class"/>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="form-group">
                            <label>Enquiry Type<span class="req redbold">*</span></label>
                            <select class="form-control" name="enquiry_type" id="edit_enquiry_type" autocomplete="off" data-validate="required">
                                <option value="">Select Enquiry Type</option>
                                <option value="Course related">Course related</option>
                                <option value="Fee related">Fee related</option>
                                <option value="Parent call">Parent call</option>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="form-group"><label>Name<span class="req redbold">*</span></label>
                            <input type="text" name="name" class="form-control" id="edit_name" data-validate="required" autocomplete="off"/>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="form-group"><label>Primary/Whatsapp Number<span class="req redbold">*</span></label>
                            <input class="form-control" maxlength="12" type="text" name="primary_mobile" placeholder="Primary Number" id="edit_primary_mobile" data-validate="required" autocomplete="off">
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="form-group"><label> Description<span class="req redbold">*</span></label>
                            <textarea class="form-control" name="comments" placeholder="Description" id="edit_comments" data-validate="required" autocomplete="off"></textarea>
                            <!-- <textarea class="form-control" name="comments" placeholder="Description" id="edit_comments"></teaxtarea> -->
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="form-group"><label> Email Id</label>
                            <input class="form-control" type="text" name="email_id" placeholder="Email Id" id="edit_email_id" autocomplete="off">
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="form-group"><label>Landline</label>
                            <input class="form-control" type="text" maxlength="12" name="landline" placeholder="Landline" id="edit_landline" autocomplete="off">
                        </div>
                    </div>
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" id="edit_course_related" >
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="form-group"><label> Course</label>
                            <select class="form-control" name="course_id" id="edit_course"  onchange="get_editbranch()">
                                <option value="">Select Course</option>
                                <?php foreach($courseArr as $course){
                                if($course['status']==1) {
                                ?>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="form-group"><label> Branch</label>
                            <select class="form-control" name="branch_id" id="edit_branch"  onchange="get_editcenter()">
            ...
            <!-- <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" id="des_edit_div"></div> -->
