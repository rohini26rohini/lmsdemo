...
<div id="edit_route" class="modal fade form_box modalCustom" role="dialog">
    <div class="modal-dialog ">
        ...
        <div class="modal-content">
            ...
            <?php foreach($routeArr as $row){ ?>
             <form id="edit_route_form" method="post">
            
            <div class="modal-body">
                    <div class="row">
                        <input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>" />
                        <input type="hidden" name="edit_transport_id" id="edit_transport_id" />
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="edit_role" id="edit_role">
                                    ...
                                    <!-- <?php //foreach($roleArr as $role){
                                        //  $selected = '';
                                        //  if($routeArr['role'] == $role['roles_id']){
                                        //     $selected = 'selected="selected"';
                                        //   }
                                        //   echo '<option value="'.$role['roles_id'].'" '.$selected.'>'.$role['role_name'].'</option>';
                                        // }
                                    ?> -->
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="table-responsive table_language">
                                <table class="table table-bordered table-striped table-sm" id="edit_no-more-tables">
                                    ...
                                    <tbody>
                                        <?php  $stopArr=$this->transport_model->get_stop_byroute($row['transport_id']);
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="role" id="role">
                                    ...
                                    <!-- <?php  //foreach ($driverArr as $key => $value) {
                                        //if($driverArr[$key]['role']=='driver'){
                                        //$drivers = $this->transport_model->check_driver_exists($driverArr[$key]['personal_id']);
                                       // if($drivers >0){ } else{ ?>
                                    	<option value="<?php //echo $driverArr[$key]['personal_id'] ?>"><?php //echo $driverArr[$key]['name'] ?></option>
                                    	<?php //} } } ?> -->
                                </select>
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="bus_id" id="bus_id" data-validate="required">
                                    ...
                                    <!-- <?php  //foreach ($busArr as $key => $value) { 
                                         //   $vehicle = $this->transport_model->check_vehicle_number_exists($driverArr['personal_id']);
                                            //    if ($vehicle>0) {}else{
                                        ?>
                                    	<option value="<?php //echo $busArr[$key]['bus_id'] ?>"><?php //echo  $busArr[$key]['vehicle_number'] ?></option>
                                    	<?php   //} } ?> -->
                                ...
                                <table class="table table-bordered table-striped table-sm" id="no-more-tables">
                                    <thead>
                                        <tr>
                                            <th>Stop Name<span class="req redbold">*</span></th>
                                            <th>Distance<span class="req redbold">*</span></th>
                                            <th>Route Fare<span class="req redbold">*</span></th>
                                            <th>Location</th>
                                            <th>Latitude<span class="req redbold">*</span></th>
                                            <th>Longitude<span class="req redbold">*</span></th>
                                            <th>Action</th>
