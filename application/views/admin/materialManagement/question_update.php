        ...
        <div class="white_card ">
            ...
            <form id="standalone" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                ...
                <div class="row ">
                    ...
                    <input type="hidden" value="<?php echo $data['question']->question_type; ?>" name="question_type" id="question_type">
            ...
            <?php if($data['question']->question_type==1){ ?>
    ...
    <?php $this->load->view('admin/scripts/materialManagement/update_script'); ?>
