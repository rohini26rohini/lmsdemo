        ...
        <form id="filter_form" method="post" action="<?php echo base_url('backoffice/export-callcenter');?>">
            ...
            <div class="row filter" id="example">
                ...
                <div class="col-sm-2 col-12">
                    ...
                    <label> Call Center Executive</label>
                    ...
                    <ul class="data_table" id ="call_center_data">
                        ...
                        <li id="row_<?php echo $calls['call_id'];?>">
                            ...
                            <div class="col " id="call_status_<?php echo $calls['call_id'];?>">
                                        ...
                                        <select class="form-control" name="call_status_list" id="edit_list_status_<?php echo $calls['call_id'];?>" onchange="get_val(<?php echo $calls['call_id'];?>)">
                                                    ...
                                                    <?php if($calls['call_status']==1){
                                                        ...
                                                        echo '<option selected value="4">Un necessary</option>
                                                            <option value="1">Call Received</option>
                                                            <option value="2">In Progress</option>
                                                            <option value="3">Closed</option>
                                                            <option value="5">Registered</option>
                                                        ...
                                                        echo '<option value="4">Un necessary</option>
                                                            <option value="1">Call Received</option>
                                                            <option value="2">In Progress</option>
                                                            <option value="3">Closed</option>
                            ...
                            <div class="col actions ">
                                ...
                                <!-- <button class="btn btn-default option_btn add_new_btn view_btn" onclick="get_follow_up_data(<?php echo $calls['call_id'];?>)">
                                    Follow Up
                                </button> -->
            ...
            <div class="modal-body">
                <form id="add_call_center_form" method="post">
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group"><label> Street Name<span class="req redbold">*</span></label>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group"><label> Center<span class="req redbold"></span></label>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group"><label>Father Mobile<span class="req redbold">*</span></label>
                                <input class="form-control" type="text" name="father_mobile" id="father_mobile" placeholder="Father Mobile" data-validate="required">
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group"><label>Mother Mobile<span class="req redbold">*</span></label>
                                <input class="form-control" type="text" name="mother_mobile" id="mother_mobile" placeholder="Mother Mobile" data-validate="required">
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group"><label>Email Id<span class="req redbold">*</span></label>
                                <input class="form-control" type="text" name="email_id" id="email_id" placeholder="Email Id" data-validate="required">
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group"><label>Hostel</label>
                                <!-- <input type ="checkbox" class="form-control" value="1" name="hostel" placeholder="Hostel"> -->
                                <!-- <div>
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="checkbox" name = "hostel" class="form-check-input" value="1">Yes
                                        </label>
                                    </div>
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="checkbox" name = "hostel" class="form-check-input" value="0">No
                                        </label>
                                    </div>
                                </div> -->
...
<div id="edit_call_center" class="modal fade form_box" role="dialog">
    <div class="modal-dialog ">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"> Edit Call Center</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
                <form id="edit_call_center_form" method="post">
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group"><label> Street<span class="req redbold">*</span></label>
                                <input class="form-control" type="text" name="street" placeholder="Street" id="edit_street" data-validate="required">
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group"><label> Qualification</label>
                                <!-- <input class="form-control" type="text" name="qualification" placeholder="Qualification" id="edit_qualification"> -->
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group"><label> Email Id<span class="req redbold">*</span></label>
                                <input class="form-control" type="text" name="email_id" placeholder="Email Id" id="edit_email_id" data-validate="required">
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group"><label> Source</label>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group"><label> Hostel</label>
                                <!-- <input class="form-control" type="text" name="hostel" placeholder="Hostel" id="edit_hostel"> -->
                                <!-- <div>
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="checkbox" name = "hostel" class="form-check-input" value="1">Yes
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group"><label> Comments</label>
                                <input class="form-control" type="text" name="comments" placeholder="Comments" id="edit_comments">
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12"></div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
