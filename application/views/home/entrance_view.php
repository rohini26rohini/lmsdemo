            ...
            <div class="row CustomRow">
                ...
                <div class="col-md-3 col-sm-12 col-12  paddleft ">
                    <div class="Notifications bgent">
                        ...
                        <a href="<?php echo base_url('upcoming-notifications-entrance');?>" class="viewbtn">View More</a>
                        <?php  } ?>
                    ...
                    <div class="subsliderbox  ">
                        ...
                        <div class="carousel-caption">
                            ...
                            <ul class="nav nav-bar ">
                                <li class="btn bgent"><a onClick="redirect('sample-test/7');" href="#">Sample Test</a></li>
                                <!-- <button class="btn btn-default" onClick="redirect('sample-test/7');">Sample Test</button> -->
                ...
                <div class="item">
                    <div class="subsliderbox Prepare">
                        ...
                        <h3>How to Prepare</h3>
                            <p>Planning to prepare for entrance exams in <?php echo date("Y");?>! Find syllabus here</p>             
                            <ul class="nav nav-bar ">
                                <li class="btn bgent"><a href="<?php echo base_url('direction-school-for-entrance-examinations-how-to-prepare');?>">View More</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="item">
                    <div class="subsliderbox netjrfStudies">
                        ...
                        <div class="carousel-caption">
                            <h3>Syllabus</h3>
                            <p>Planning to prepare for entrance  exams in <?php echo date("Y");?>! Find syllabus here</p>    
                            <li class="btn bgent"><a href="<?php echo base_url('direction-school-for-entrance-examinations-syllabus/'.$syllabus.'');?>">View More</a></li>
                        </div>
                    </div>
                </div>
                ...
                <div class="item">
                    <div class="subsliderbox netjrfStudies">
                        ...
                        <div class="carousel-caption">
                            ...
                            <p>A collection of previous year question papers of School for entrance examinations</p>    
                            <li class="btn bgpsc"><a href="<?php echo base_url('direction-school-for-entrance-examinations-previous-question/'.$previous_question.'');?>">View More</a></li>
                        </div>
                    </div>
                </div>
                <?php }?>
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                    <div class="ourprograms">
                        <h4>Our Programs</h4>
                        <p>Direction School For Entrance Examinations</p>
                        <div id="ourprograms" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner">
                                <?php
                                $courses = $this->common->get_coursesby_school(7);
                                if(!empty($courses)){
                                ...
                                <div class="carousel-item <?php if($i==1){ echo 'active'; }?>">          
                                    ...
                                    <div class="carouselcaption">
                                        ...
                                        <a href="<?php echo base_url();?>detailed_batch/<?php echo $course->class_id.'/'.$course->school_id;?>" class="btn bgent">More Details</a>
                                    </div>
                                </div>
                                <?php $i++;} }?>
                            </div>
                            ...
                            <?php if($success['document_type']==1){?>
                                <div class="carousel-item <?php if($i == 1){ echo 'active'; }?> ">
                                   ...
                                   <?php } else { ?>
                                    ...
                                    </div><a href="<?php echo base_url();?>school-stories/7" data-toggle="tooltip" data-placement="top" title="" class="SStoryView entranceStoryView" data-original-title="More !"><i class="fas fa-chevron-right"></i></a>
                                </div>
                                <?php } ?>
                                <?php $i++; endforeach; ?>
                            </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                    <div class="gallery entrancegallery">
                        <h4>Event Gallery</h4>
                        <div class="gallery">
                        <ul class="nav nav-bar">
                        <?php
    ...
    <div class="special">
        <div class="container maincontainer">
            <div class="title">
                <h4 class="text-center">What is special about direction school for entrance examinations</h4>
            </div>
            <div class="specialcondent Achievement">
                <div class="condentimg">
                    <img src="<?php echo base_url();?>direction_v2/images/direction-entrance.png" alt="special" class="rounded-circle img-fluid">
                </div>
