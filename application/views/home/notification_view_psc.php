...
<div class="abtbanner BgGrdOrange ">
    <div class="container maincontainer">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?php echo base_url('direction-school-for-psc-examinations'); ?>">Direction School for PSC Examinations </a></li>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-sm table_exam_details">
                            ...
                            ?>
                                <td><?php echo $i;?></td>
                                <td>
                                <a href="<?php echo base_url('detailed-notification-psc/'.$notification['notification_id']);?>">
