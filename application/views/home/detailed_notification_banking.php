                        ...
                        <div id="collapseOne" class="collapse show" data-parent="#accordion" style="">
                            <div class="card-body">
                                <ul class=" list-unstyled ">
                                    <?php $notifications= $this->common->get_notifications(5); 
                                    if(!empty($notifications)) {
                                        foreach($notifications as $not) {
                                            echo '<li><a href="'.base_url('detailed-notification-banking/'.$not['notification_id']).'">'.$not['name'].'</a></li>';
                                        }
                                    }
                                    ?>
                                </ul>
                    ...
                    foreach ($detailedArr as $row){?>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="form-group">
                                    <a class="btn btn-warning btn_next" href="<?php echo $row->file?>" target="_blank">Apply Online</a>

                            <!-- <button class="btn btn-warning btn_next" type="submit">Apply Online</button> -->
                            </div>
                        </div>
                    <?php   
                    }
