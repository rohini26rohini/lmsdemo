            ...
            <div class="row CustomRow">
                ...
                <div class="col-md-3 col-sm-12 col-12  paddleft ">
                    <div class="Notifications bnkbg">
                                ...
                                <ul class="demo1">
                                    ...
                                    <li class="news-item Aligner">
                                        ...
                                        <?php if($notification['file']!=''){ ?>
                                            <p>
                                                <a href="<?php echo base_url('upcoming-notifications-banking');?>" target="_blank"><?php echo $notification['name']?></a>
                                            </p>
                                        <?php }else{ ?>
                        ...
                        <a href="<?php echo base_url('upcoming-notifications-banking');?>" class="viewbtn">View More</a>
                        <?php  } ?>
            ...
            <div class="owl-carousel owl-theme Takesection" id="Takebox">
                    ...
                    <div class="subsliderbox  ">
                        ...
                        <div class="carousel-caption">
                            ...
                            <ul class="nav nav-bar ">
                                <li class="btn bnkbg"><a onClick="redirect('sample-test/5');" href="#">Sample Test</a></li>
                                <!-- <button class="btn btn-default" onClick="redirect('sample-test/5');">Sample Test</button> -->

                                <!-- <li class="btn bnkbg"><a href="#">Purchase a Test</a></li> -->
                            </ul>
                            <br>
                ...
                <div class="item">
                    <div class="subsliderbox Prepare">
                        ...
                        <h3>How to Prepare</h3>
                            <p>Planning to prepare for bank exams in <?php echo date("Y");?>! Find syllabus here</p>             
                            <ul class="nav nav-bar ">
                                <li class="btn bnkbg"><a href="<?php echo base_url('direction-school-of-banking-how-to-prepare');?>">View More</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="item">
                    <div class="subsliderbox netjrfStudies">
                        ...
                        <div class="carousel-caption">
                            <h3>Syllabus</h3>
                            <p>Planning to prepare for banking exams in <?php echo date("Y");?>! Find syllabus here</p>    
                            <li class="btn bnkbg"><a href="<?php echo base_url('direction-school-of-banking-syllabus/'.$syllabus.'');?>">View More</a></li>
                        </div>
                    </div>
                </div>
                ...
                <div class="item">
                    <div class="subsliderbox netjrfStudies">
                        ...
                        <div class="carousel-caption">
                            ...
                            <p>A collection of previous year question papers of School of Banking examinations</p>    
                            <li class="btn bnkbg"><a href="<?php echo base_url('direction-school-of-banking-previous-question/'.$previous_question.'');?>">View More</a></li>
                        </div>
                    </div>
                </div>
                <?php }?>
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                    <div class="ourprograms">
                        <h4>Our Programs</h4>
                        <p>Direction School of Banking</p>
                        <div id="ourprograms" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner">
                                <?php $courses = $this->common->get_coursesby_school(5);
                                if(!empty($courses)){ $i =1;
                                ...
                                <div class="carousel-item <?php if($i==1){ echo 'active'; }?>">         
                                    ...
                                    <div class="carouselcaption">
                                        ...
                                        <a href="<?php echo base_url();?>detailed_batch/<?php echo $course->class_id.'/'.$course->school_id;?>" class="btn bnkbg">More Details</a>
                                    </div>
                                </div>
                                <?php $i++; } } ?>
                            </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                    <div class="success bnksuccess">
                        <h4>Success Story</h4>
                        <div id="successstory" class="carousel slide" data-ride="carousel">
                            <ul class="carousel-indicators">
                                <?php $i =0; foreach ($successArr as $success){ ?>
                            ...
                            <div class="carousel-inner">
                                ...
                                <div class="carousel-item <?php if($i == 1){ echo 'active'; } ?> ">
                                   ...
                                   <?php } else { ?>
                                    ...
                                    <a href="<?php echo base_url();?>school-stories/5" data-toggle="tooltip" data-placement="top" title="" class="SStoryView bnkSStoryView" data-original-title="More !"><i class="fas fa-chevron-right"></i></a>
                                </div>
                                <?php } ?>
                                <?php $i++; endforeach; ?>
                            </div>
                ...
                <?php if ($schoolgalleryArr != null) { ?>
                <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                    <div class="gallery bnkgallery">
                        <h4>Event Gallery</h4>
                        <div class="gallery">
                            <ul class="nav nav-bar">
                                <?php $i =1; foreach ($schoolgalleryArr as $image){?>
    ...
    <div class="special">
        <div class="container maincontainer">
            <div class="title">
                <h4 class="text-center">What is special about Direction School for Banking</h4>
            </div>
            <div class="specialcondent Achievement">
                <div class="condentimg">
                    <img src="<?php echo base_url();?>direction_v2/images/direction-banking.png" alt="special" class="rounded-circle img-fluid">
                </div>
