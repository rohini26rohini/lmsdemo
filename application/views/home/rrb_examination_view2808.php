            ...
            <div class="row CustomRow">
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12  paddleft ">
                    <div class="Notifications rrbg">
                       ...
                       <a href="<?php echo base_url('upcoming-notifications-rrb');?>" class="viewbtn">View More</a>
                       <?php  } ?>
                ...
                <div class="subsliderbox  ">
                    ...
                    <div class="carousel-caption">
                        ...
                        <ul class="nav nav-bar ">
                            <li class="btn bgrrb"><a onClick="redirect('sample-test/8');" href="#">Sample Test</a></li>
                ...
                <div class="item">
                    <div class="subsliderbox Prepare">
                        ...
                        <h3>How to Prepare</h3>
                            <p>Planning to prepare for RRB exams in <?php echo date("Y");?>! Find syllabus here</p>             
                            <ul class="nav nav-bar ">
                                <li class="btn bgrrb"><a href="<?php echo base_url('direction-school-for-rrb-examinations-how-to-prepare');?>">View More</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="item">
                    <div class="subsliderbox netjrfStudies">
                        ...
                        <div class="carousel-caption">
                            <h3>Syllabus</h3>
                            <p>Planning to prepare for RRB exams in <?php echo date("Y");?>! Find syllabus here</p>    
                            <li class="btn bgrrb"><a href="<?php echo base_url('direction-school-for-psc-examinations-syllabus/'.$syllabus.'');?>">View More</a></li>
                        </div>
                    </div>
                </div>
                ...
                <div class="item">
                    <div class="subsliderbox netjrfStudies">
                        ...
                        <div class="carousel-caption">
                            ...
                            <p>A collection of previous year question papers of School of RRB examinations</p>    
                            <li class="btn bgrrb"><a href="<?php echo base_url('direction-school-for-psc-examinations-previous-question/'.$previous_question.'');?>">View More</a></li>
                        </div>
                    </div>
                </div>
                <?php }?>
        ...
        <div class="container maincontainer">
            <div class="row">
                <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="ourprograms rrbprograms">
                        <h4>Our Programs</h4>
                        <p>Direction RRB Examinations</p>
                        <div id="ourprograms" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner">
                                <?php
                                $courses = $this->common->get_coursesby_school(8);
                                ...
                                <div class="carousel-item <?php if($i==1){ echo 'active'; } ?> ">             
                                    ...
                                    <div class="carouselcaption">
                                        ...
                                        <a href="<?php echo base_url();?>detailed_batch/<?php echo $course->class_id.'/'.$course->school_id;?>" class="btn bgrrb">More Details</a>
                                    </div>
                                </div>
                                <?php $i++;} ?>
                    ...
                    <div class="success rrbsuccess">
                        ...
                        <div id="successstory" class="carousel slide" data-ride="carousel">
                            ...
                            <?php if($success['document_type']==1){?>
                                <div class="carousel-item <?php if($i == 1){ echo 'active'; }?> ">
                                    <div class="caption">
                                        <p><?php $str1=$success['description'];  $str = substr($str1, 0, 130); echo strip_tags($str);?></p>
                                    ...
                                    </div><a href="<?php echo base_url();?>school-stories/8" data-toggle="tooltip" data-placement="top" title="" class="SStoryView rrbStoryView" data-original-title="More !"><i class="fas fa-chevron-right"></i></a>
                                </div>
                                <?php } ?>
                                <?php $i++; endforeach; ?>
                            </div>
    ...
    <div class="special">
        <div class="container maincontainer">
            <div class="title">
                <h4 class="text-center">What is special about Direction School for RRB Examinations</h4>
            </div>
            <div class="specialcondent Achievement">
                <div class="condentimg">
                    <img src="<?php echo base_url();?>direction_v2/images/direction-rrb.png" alt="special" class="rounded-circle img-fluid">
                </div>
