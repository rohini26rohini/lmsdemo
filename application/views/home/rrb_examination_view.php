                ...
                <div class="item">
                    <div class="subsliderbox netjrfStudies">
                        ...
                        <div class="carousel-caption">
                            <h3>Syllabus</h3>
                            <p>Planning to prepare for RRB exams in <?php echo date("Y");?>! Find syllabus here</p>    
                            <li class="btn bgrrb"><a href="<?php echo base_url('direction-school-for-rrb-examinations-syllabus/'.$syllabus.'');?>">View More</a></li>
                        </div>
                    </div>
                </div>
                ...
                <div class="item">
                    <div class="subsliderbox netjrfStudies">
                        ...
                        <div class="carousel-caption">
                            ...
                            <li class="btn bgrrb"><a href="<?php echo base_url('direction-school-for-rrb-examinations-previous-question/'.$previous_question.'');?>">View More</a></li>
                        </div>
                    </div>
                </div>
                <?php }?>
