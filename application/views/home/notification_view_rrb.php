 ...
 <div class="abtbanner BgGrdOrange ">
    <div class="container maincontainer">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?php echo base_url('direction-school-for-rrb-examinations'); ?>">Direction school for RRB examinations</a></li>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-sm table_exam_details">
                            ...
                            ?>
                                <td><?php echo $i;?></td>
                                <td>
                                <a href="<?php echo base_url('detailed-notification-rrb/'.$notification['notification_id']);?>">
