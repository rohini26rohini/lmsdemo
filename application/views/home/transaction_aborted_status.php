                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 m-auto">
                        <div class="PaymentWapper">
                            <div class="paymentheader payheadercolor">
                                <h3>Payment Status</h3>
                            </div>
                                <div class="paymentbody">
                                   <h3>Your payment has failed/cancelled</h3>
                                   <p>Here are the details of this transaction for your reference.</p>
                                   <p>Transaction ID : <strong><?php echo $tracking_id;?></strong></p>
                                   <p>Transaction Amount : <strong><?php echo $amount;?></strong></p>
                                   <p>Status : <strong><?php echo $order_status;?></strong></p>
                                </div>
                        </div>
