...
<body>
    <div class="abtbanner BgGrdOrange ">
        <div class="container maincontainer">
            <h3>UPSC Civil Services Exam For Aspirants</h3>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>"><i class="fas fa-home"></i> Home</a></li>
                <li class="breadcrumb-item active" aria-current="page">UPSC Civil Services Exam For aspirants</li>
            </ol>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="CourseMainBox CourseContent">
                        <h1>For Aspirants Targeting <span>UPSC Civil Services Exam</span></h1>
                        <div class="row">
