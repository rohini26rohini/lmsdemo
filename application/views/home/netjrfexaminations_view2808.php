            ...
            <div class="row CustomRow">
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12  paddleft ">
                    <div class="Notifications bgnet ">
                        ...
                        <a href="<?php echo base_url('upcoming-notifications-net');?>" class="viewbtn">View More</a>
                        <?php  } ?>
    ...
    <div class="Takesection netjrfTakesection">
        <div class="container maincontainer">
                    ...
                    <div class="subsliderbox  ">
                        ...
                        <div class="carousel-caption">
                            ...
                            <ul class="nav nav-bar ">
                                <li class="btn bgnet"><a onClick="redirect('sample-test/2');" href="#">Sample Test</a></li>
                                <!-- <button class=" btn iasbg btn-default" onClick="redirect('sample-test/1');">Sample Test</button> -->

                                <!-- <li class="btn bgnet"><a href="#">Purchase a Test</a></li> -->
                            </ul><br>
                ...
                <div class="item">
                    <div class="subsliderbox Prepare">
                        ...
                        <h3>How to Prepare</h3>
                            <p>Planning to prepare for NET / JRF exams in <?php echo date("Y");?>! Find syllabus here</p>             
                            <ul class="nav nav-bar ">
                                <li class="btn bgnet"><a href="<?php echo base_url('direction-school-for-netjrf-examinations-how-to-prepare');?>">View More</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="item">
                    <div class="subsliderbox netjrfStudies">
                        ...
                        <div class="carousel-caption">
                            <h3>Syllabus</h3>
                            <p>Planning to prepare for NET / JRF exams in <?php echo date("Y");?>! Find syllabus here</p>    
                            <li class="btn bgnet"><a href="<?php echo base_url('direction-school-for-netjrf-examinations-syllabus/'.$syllabus.'');?>">View More</a></li>
                        </div>
                    </div>
                </div>
                ...
                <div class="item">
                    <div class="subsliderbox netjrfStudies">
                        ...
                        <div class="carousel-caption">
                            ...
                            <p>A collection of previous year question papers of School for NET / JRF examinations</p>    
                            <li class="btn bgnet"><a href="<?php echo base_url('direction-school-for-netjrf-examinations-previous-question/'.$previous_question.'');?>">View More</a></li>
                        </div>
                    </div>
                </div>
                <?php }?>
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                    <div class="ourprograms">
                        <h4>Our Programs</h4>
                        <p>Direction School for NET/JRF Examinations</p>
                        <div id="ourprograms" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner">
                                <?php
                                $courses = $this->common->get_coursesby_school(2);
                                if(!empty($courses)){
                                $i =1;
                                ...
                                <div class="carousel-item <?php if($i==1){ echo 'active';}?>">             
                                    ...
                                    <div class="carouselcaption">
                                        ...
                                        <a href="<?php echo base_url();?>detailed_batch/<?php echo $course->class_id.'/'.$course->school_id;?>" class="btn bgnet">More Details</a>
                                    </div>
                                </div>
                                <?php $i++;}} ?>
                            </div>
                            ...
                            <div class="carousel-inner">
                                ...
                                <?php if($success['document_type']==1){?>
                                    <div class="carousel-item <?php if($i == 1){ echo 'active'; }?> ">
                                        ...
                                        <a href="<?php echo base_url();?>school-stories/2" data-toggle="tooltip" data-placement="top" title="More !" class="SStoryView"><i class="fas fa-chevron-right"></i></a>
                                    </div>
                                <?php } ?>
                                <?php $i++; endforeach; ?>
                            </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                    <div class="gallery netjrfgallery">
                        <h4>Event Gallery</h4>
                        <div class="gallery">
                            <ul class="nav nav-bar">
    ...
    <div class="special">
        <div class="container maincontainer">
            <div class="title">
                <h4 class="text-center">What is special about direction school for NET/JRF examinations</h4>
            </div>
            <div class="specialcondent Achievement">
                <div class="condentimg">
                    <img src="<?php echo base_url();?>direction_v2/images/direction-net.png" alt="special" class="rounded-circle img-fluid">
                </div>
