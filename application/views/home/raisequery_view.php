 <section class="top_strip" style="background-image: url(<?php echo base_url();?>assets/images/banner_bg.png);">
        <div class="container">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"> Raise a Query
                </li>
            </ol>
        </div>
    </section>
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 ">
                        <div class="form_box_wrapper">
                            <h1 class="inner_head">Raise a Query
                            </h1>
                                <div class="alert alert-success" id="success_msg" style="display:none;">
                                    <strong>Submitted Successfully!</strong>
                                </div>
                            <div class="alert alert-danger" id="error_msg" style="display:none;">
                                    <strong>Network Error!Please try again later</strong>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="input-group form_input_group">
                                        ...
                                        <input type="hidden" class="form-control"  name="enquiry_type" value="1">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="input-group form_input_group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Phone *" onkeypress="return valNum(event)" name="enquiry_phone">
                                    </div>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="form_bg" style="background-image: url(<?php echo base_url();?>assets/images/Raise%20A%20Query.png)"></div>
                    </div>
                </div>
...
<?php $this->load->view("home/scripts/raisequery_script");?>sss
