                ...
                <div class="noti" id="accordion">
                    <div class="card ">
                         <div class="card-header ">
                            ...
                            Direction School for entrance examinations
                            </a>
                        </div>
                        <div id="collapseOne" class="collapse show" data-parent="#accordion" style="">
                            <div class="card-body">
                                <ul class=" list-unstyled ">
                                    <?php $notifications= $this->common->get_notifications(7); 
                                    if(!empty($notifications)) {
                                        foreach($notifications as $not) {
                                            echo '<li><a href="'.base_url('detailed-notification-entrance/'.$not['notification_id']).'">'.$not['name'].'</a></li>';
                                        }
                                    }
                                    ?>
                                </ul>
