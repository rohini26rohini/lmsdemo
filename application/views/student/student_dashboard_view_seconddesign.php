...
<section class="nav_profile ">
    <div class="container">
        <ul class="nav nav-pills ">
            ...
            <li><a data-toggle="pill" href="#studProfile" id="profileid">Profile</a></li>
            ...
            <!--<li><a data-toggle="pill" href="#studAttendance" id="studentattendance">Attendance</a></li> -->
             <li><a data-toggle="pill" href="#studProgress" id="studentprogress">Result</a></li> 
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="proggress-box">
                                <div id="example-<?php echo $row->course_id;?>" class="examples">
    ...
    <div class="series-wapper">
        <div class="container">
            ...
            <!-- <div class="container breadcrumb-boxs">
                ...
                <div class="col-md-12"><h3>Exam Results </h3></div>
                <div class="col-md-12">
                    <div class="dash-box-shadow exam-box">
                        <dv class="d-flex justify-space-between align-self">
                            <!-- <h3>Exam Schedule</!-->
