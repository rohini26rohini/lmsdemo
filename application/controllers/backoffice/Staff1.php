        ...
        foreach($categoryArr as $category){
            ...
            if(isset($specificationArr[$i])){ 
                ...
                if($exist != 0){ 
                   ...
                   //print_r($specificationArr); print_r($edit_personal_id);
                    $result=$this->staff_enrollment_model->staff_education_edit($edit_personal_id,$data,$specificationArr[$i], $category);
                    ...
                    foreach($documents as $row){ 
                        ...
                        $html = $html.'</div>
                            <div class="col actions">
                                ...
                                <button class="btn btn-default option_btn" title="Delete" onclick="delete_fromtable('.$row->staff_documents_id.')">
                                    <i class="fa fa-trash-o"></i>
                                </button>
                            </div>
                        </li>';
        ...
        if($data->num_rows() > 0){
            ...
            foreach($data->result() as $row){
                ...
                $output .= '<tr>
                            ...
                            <td>'.$days.'</td>
                            <td><button class="btn btn-default option_btn" onclick="get_data('.$row->avai_id.')"> <i class="fa fa-pencil "></i> </button><button class="btn btn-default option_btn" title="Delete" onclick="delete_availability('.$row->avai_id.')"><i class="fa fa-trash-o"></i></button>
                            </td>
                            </tr>';
                            $i++;
                        }
